...
USER = os.getenv("USER", "pylovo")
HOST = os.getenv("HOST", "localhost")
PORT = os.getenv("PORT", "5555")
PASSWORD = os.getenv("PASSWORD", "pylovo")
...
# dummy import files for buildings
# OGR_FILE_LIST = [
# dummy_region_name
#     {"path": os.path.join(".", "raw_data", "buildings", "Res_<ags_number>.shp"), "table_name": "res"},
#     {"path": os.path.join(".", "raw_data", "buildings", "Oth_<ags_number>.shp"), "table_name": "oth"},
#     {"path": os.path.join(".", "raw_data", "<substation_region_name>.geojson"), "table_name": "transformers"},
# ]

CSV_FILE_LIST = [
    {"path": os.path.join(".", "raw_data", "betriebsmittel.csv"), "table_name": "betriebsmittel"},
    {"path": os.path.join(".", "raw_data", "postcode.csv"), "table_name": "postcode"},
    # {"path": os.path.join(".", "raw_data", "ways.csv"), "table_name": "ways"},
]
